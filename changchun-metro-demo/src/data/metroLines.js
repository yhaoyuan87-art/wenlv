export const metroLines = [
  ...
  },
  {
    ...
    stations: [
      ...
      { stationId: 'st-02-11', name: '解放桥', x: 485, y: 324, transfer: ['line-06'] },
  ...
  },
  {
    ...
    stations: [
      ...
      { stationId: 'st-03-10', name: '抚松路', x: 322, y: 420 },
      { stationId: 'st-03-11', name: '南湖广场', x: 350, y: 448 },
      { stationId: 'st-03-12', name: '辉南街', x: 368, y: 466 },
      { stationId: 'st-03-13', name: '前进西', x: 382, y: 484 },
      { stationId: 'st-03-14', name: '卫明街', x: 394, y: 494 },
      { stationId: 'st-03-15', name: '前进大街', x: 406, y: 504 },
      { stationId: 'st-03-16', name: '电台街', x: 420, y: 510 },
      { stationId: 'st-03-17', name: '硅谷大街', x: 465, y: 516 },
      { stationId: 'st-03-18', name: '吉林大学', x: 510, y: 519 },
  ...
  },
  {
    ...
    stations: [
      ...
      { stationId: 'st-06-03', name: '腾跃广场', x: 248, y: 376 },
      { stationId: 'st-06-04', name: '支农大街', x: 262, y: 400 },
      { stationId: 'st-06-05', name: '宽平桥', x: 314, y: 394, transfer: ['line-03'] },
      { stationId: 'st-06-06', name: '孟家屯', x: 344, y: 412, transfer: ['line-07'] },
      { stationId: 'st-06-07', name: '南湖大路', x: 430, y: 428 },
      { stationId: 'st-06-08', name: '解放桥', x: 485, y: 324, transfer: ['line-02'] },
      { stationId: 'st-06-09', name: '繁荣路', x: 553, y: 486, transfer: ['line-01'] },
      { stationId: 'st-06-10', name: '前进大街南', x: 636, y: 486 },
      { stationId: 'st-06-11', name: '南溪湿地', x: 694, y: 504 },
      { stationId: 'st-06-12', name: '福祉大路', x: 810, y: 668, transfer: ['line-04'] },
      { stationId: 'st-06-13', name: '吴家店', x: 848, y: 688 },
      { stationId: 'st-06-14', name: '樱花路', x: 876, y: 694 },
      { stationId: 'st-06-15', name: '省博物院', x: 902, y: 680 },
  ...
  },
  {
    ...
    stations: [
      ...
      { stationId: 'st-07-04', name: '孟家屯', x: 344, y: 412, transfer: ['line-06'] },
      { stationId: 'st-07-05', name: '电台街', x: 400, y: 426 },
      { stationId: 'st-07-06', name: '抚松路', x: 450, y: 432 },
      { stationId: 'st-07-07', name: '南湖广场', x: 492, y: 436 },
      { stationId: 'st-07-08', name: '工农广场', x: 554, y: 450, transfer: ['line-01'] },
      { stationId: 'st-07-09', name: '东岭南街', x: 616, y: 430 },
      { stationId: 'st-07-10', name: '赛得广场', x: 664, y: 430 },
      { stationId: 'st-07-11', name: '威海路', x: 716, y: 426 },
      { stationId: 'st-07-12', name: '会展大街', x: 756, y: 418 },
      { stationId: 'st-07-13', name: '公平路', x: 790, y: 408 },
      { stationId: 'st-07-14', name: '岭东路', x: 820, y: 394 },
  ...
  },
  {
    ...
    stations: [
      ...
      { stationId: 'st-08-02', name: '小南', x: 543, y: 112 },
      { stationId: 'st-08-03', name: '一二三中学', x: 539, y: 94 },
      { stationId: 'st-08-04', name: '和安街', x: 534, y: 78 },
      { stationId: 'st-08-05', name: '北湖大桥', x: 527, y: 64 },
      { stationId: 'st-08-06', name: '北湖公园', x: 519, y: 52 },
      { stationId: 'st-08-07', name: '光机路', x: 510, y: 42 },
      { stationId: 'st-08-08', name: '大学城路', x: 524, y: 30 },
      { stationId: 'st-08-09', name: '奥林匹克公园', x: 542, y: 24 },
      { stationId: 'st-08-10', name: '广通路', x: 562, y: 26 },
      { stationId: 'st-08-11', name: '地理所', x: 582, y: 34 }
    ]
  }
]
